// Shopping cart for the grocery tab (Phosphor: shopping-cart). Outline by
// default; `filled` swaps to the solid weight for the active tab. Both weights
// are single currentColor paths on a 256 grid, so they share one <svg>.
const OUTLINE =
...
export function Cart(props: { size?: number; filled?: boolean }) {
  ...
  return (
    <svg
      ...
      focusable="false"
    >
      <path d={props.filled ? FILL : OUTLINE} />
    </svg>
  );
}
